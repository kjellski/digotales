    ...
    assets: [
      {
        ...
        url: '/images/character/obama_not_bad.jpg'
      }, 
    ]
  }, {
    name: 'items',
    assets: [
      {
        name: 'batman style!',
        tags: [ 'speech' ],
        url: '/images/items/bang.png'
      }, {
        name: 'let\'s talk',
        tags: [ 'speech' ],
        url: '/images/items/speech_bubble.png'
      }, {
        name: 'SPARTAAAA',
        tags: [ 'speech' ],
        url: '/images/items/speech_bubble_strong.png'
      }, {
        name: 'just thinking...',
        tags: [ 'speech' ],
        url: '/images/items/thought-bubble.png'
      }
    ]
  }, {
    name: 'backgrounds',
    assets: [
      {
        name: '*owly wohooooo*',
        tags: [ 'dark'],
        url: '/images/backgrounds/dark.jpg'
      }, {
        name: 'parteyyy',
        tags: [ 'night'],
        url: '/images/backgrounds/skyline.jpg'
      }
    ]
  }, function(err) {
